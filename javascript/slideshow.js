jQuery(document).ready(function ($) {
    ...
    $(".page-wrapper").prepend('<div id="slider1_container" style="position: absolute; top: 180px; left: -600px; height: 699px; overflow: hidden; z-index: 1; width: 2500px"> \
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; height: 699px; overflow: hidden; width: 2500px;"> \
